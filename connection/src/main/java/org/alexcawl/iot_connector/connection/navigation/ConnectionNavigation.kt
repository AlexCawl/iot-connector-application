...
import org.alexcawl.iot_connector.connection.ui.update.add.component.AddConnectionScreen
import org.alexcawl.iot_connector.connection.ui.update.edit.EditConnectionViewModel
import org.alexcawl.iot_connector.connection.ui.update.edit.component.EditConnectionScreen
...
fun NavGraphBuilder.connectionNavigation(
    ...
    val factory = ConnectionComponentStore.component.provideFactory()
    ...
    installShowConnectionsScreen(
        ...
        onNavigateToEditConnection = { navController.navigate(
            ConnectionNavLocator.ConnectionEditScreen.buildRoute(
                it
            )
        ) },
