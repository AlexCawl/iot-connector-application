...
@Composable
fun ThermalMatrixViewerScreen(
    state: ThermalMatrixRepresentationModel,
    modifier: Modifier = Modifier
) = Scaffold {
    Column(
        modifier = modifier.padding(it).padding(ExtendedTheme.padding.medium),
...
private fun Preview() {
    ...
    val state = ThermalMatrixRepresentationModel(temperatures)
    IoTConnectorTheme {
        ThermalMatrixViewerScreen(state = state)
    }
}